      ...
      {sceneKeys.map((key, i) => {
        ...
        return (
          <button
            ...
            aria-label={`Przejdź do sceny ${i + 1}`}
  ...
  return (
    ...
    >
      <button
        ...
        title={locked ? 'Powtarzaj scenę: włączone' : 'Powtarzaj scenę: wyłączone'}
        aria-label={locked ? 'Powtarzaj scenę: włączone' : 'Powtarzaj scenę: wyłączone'}
        aria-pressed={locked}
      >
      ...
      <button
        ...
        title={collapsed ? 'Pokaż kontrolki' : 'Ukryj kontrolki'}
        aria-label={collapsed ? 'Pokaż kontrolki' : 'Ukryj kontrolki'}
...
export default function VideoWithControls() {
  ...
  if (!isIframed || isEmbed) return <VideoTemplate />;
